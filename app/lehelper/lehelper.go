...
func GenerateUserdata(userdata string, opts *types.InstanceCreateOpts) (string, error) {
	var params = cloudinit.Params{
		...
		EgressControl:                opts.EgressControl,
		TPAAddress:                   opts.TPAAddress,
		TPAPort:                      opts.TPAPort,
		EgressProxyEnabled:           opts.EgressProxyEnabled,
		EgressProxyURL:               opts.EgressProxyURL,
		EgressNoProxy:                opts.EgressNoProxy,
		EgressCACert:                 opts.EgressCACert,
		EnableLEDiagnostics:          opts.EnableLEDiagnostics,
