...
func (d *DistributedManager) provisionFromPool(
	...
	if reservedCapacity != nil {
		resInst, hotpool, resErr := d.provisionFromReservedCapacity(ctx, pool, tlsServerName, ownerID, setupParams, vmImageConfig, agentConfig, storageConfig, timeout, poolName, reservedCapacity, isCapacityTask)
