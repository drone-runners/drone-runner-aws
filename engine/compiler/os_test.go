...
func Test_convertVolumesToString(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "sourcedir, empty step volume",
			args: args{
				sourcedir:         "/bla",
				stepVolumes:       []*resource.VolumeMount{},
		...
		{
			name: "sourcedir, step volume and volumeMap",
			args: args{
				sourcedir:         "/bla",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if gotVolumeString := convertVolumesToString(tt.args.sourcedir, tt.args.stepVolumes, tt.args.pipeLineVolumeMap); gotVolumeString != tt.wantVolumeString {
...
func Test_convertCommandsToEntryPointString(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if gotEntryPoint := convertCommandsToEntryPointString(tt.commands); gotEntryPoint != tt.wantEntryPoint {
