...
func BuildCount() *prometheus.CounterVec {
	return prometheus.NewCounterVec(
		...
		[]string{"pool_id", "os", "arch", "driver", "distributed", "zone", "owner_id", "resource_class", "image_version", "image_name", "variant_id"},
	)
}
...
func WaitDurationCount() *prometheus.HistogramVec {
	return prometheus.NewHistogramVec(
		prometheus.HistogramOpts{
			...
			Buckets: []float64{0.5, 1, 3, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65, 70, 75, 80, 90, 100, 110, 120, 180, 300, 600, 900, 1800},
		},
