...
- 'wget -nv https://github.com/tmate-io/tmate/releases/download/2.4.0/tmate-2.4.0-static-linux-amd64.tar.xz -O /addon/tmate.xz'
...
- 'wget -nv https://github.com/tmate-io/tmate/releases/download/2.4.0/tmate-2.4.0-static-linux-arm64v8.tar.xz -O /addon/tmate.xz'
- 'tar -xf /addon/tmate.xz -C /addon/'
