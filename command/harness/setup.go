...
func HandleSetup(
	...
	for idx, p := range pools {
		...
		instance, warmed, hibernated, variantID, poolErr = handleSetup(ctx, logr, internalLogr, r, runnerName, enableMock, mockTimeout, poolManager, pool, owner, capacity, metrics)
