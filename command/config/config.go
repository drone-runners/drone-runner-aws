...
type EnvConfig struct {
	...
	Runner struct {
		...
		HealthCheckTimeout        int64             `envconfig:"DRONE_RUNNER_HEALTH_CHECK_TIMEOUT" default:"3"`
		HealthCheckWindowsTimeout int64             `envconfig:"DRONE_RUNNER_HEALTH_CHECK_WINDOWS_TIMEOUT" default:"5"`
	}
	...
	LiteEngine struct {
		Path                string `envconfig:"DRONE_LITE_ENGINE_PATH" default:"https://github.com/harness/lite-engine/releases/download/v0.5.105/"`
		FallbackPath        string `envconfig:"DRONE_LITE_ENGINE_FALLBACK_PATH" default:"https://app.harness.io/storage/harness-download/harness-ti/harness-lite-engine/v0.5.105/"`
