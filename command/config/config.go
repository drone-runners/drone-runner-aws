...
type EnvConfig struct {
	...
	Settings struct {
		...
		AutoInjectionBinaryURI       string `envconfig:"DRONE_HARNESS_AUTO_INJECTION_BINARY_URI" default:"https://app.harness.io/storage/harness-download/harness-ti/auto-injection/1.0.10"`
		AnnotationsBinaryURI         string `envconfig:"DRONE_ANNOTATIONS_CLI_URI" default:"https://raw.githubusercontent.com/DevanshMathur19/AnnotateCLI/CI-19004/cli"`
		AnnotationsBinaryFallbackURI string `envconfig:"DRONE_ANNOTATIONS_CLI_FALLBACK_URI" default:"https://github.com/DevanshMathur19/AnnotateCLI/raw/CI-19004/cli"`
	}

	LiteEngine struct {
		Path                string `envconfig:"DRONE_LITE_ENGINE_PATH" default:"https://github.com/harness/lite-engine/releases/download/v0.5.129-debug-2/"`
		FallbackPath        string `envconfig:"DRONE_LITE_ENGINE_FALLBACK_PATH" default:"https://app.harness.io/storage/harness-download/harness-ti/harness-lite-engine/v0.5.129-debug-2/"`
