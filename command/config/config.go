...
type EnvConfig struct {
	...
	Settings struct {
		...
		AutoInjectionBinaryURI string `envconfig:"DRONE_HARNESS_AUTO_INJECTION_BINARY_URI" default:"https://app.harness.io/storage/harness-download/harness-ti/auto-injection"`
	}
	LiteEngine struct {
