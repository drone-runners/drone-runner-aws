...
type EnvConfig struct {
	...
	Settings struct {
		...
		PluginBinaryURI         string `envconfig:"DRONE_PLUGIN_BINARY_URI" default:"https://github.com/drone/plugin/releases/download/v3.9.1-beta"`
		PluginBinaryFallbackURI string `envconfig:"DRONE_PLUGIN_BINARY_FALLBACK_URI" default:"https://app.harness.io/storage/harness-download/harness-ti/harness-plugin/v3.9.1-beta"`
		...
		PluginBinaryURIv2       string `envconfig:"DRONE_PLUGIN_BINARY_URI_V2" default:"https://github.com/drone/plugin/releases/download/<TAG_FOR_V2>"`
		UseV2Plugin             bool   `envconfig:"USE_NEKTOS_ACT_NODE_20" default:"false"`
	}
	LiteEngine struct {
		Path                string `envconfig:"DRONE_LITE_ENGINE_PATH" default:"https://github.com/harness/lite-engine/releases/download/v0.5.104/"`
		FallbackPath        string `envconfig:"DRONE_LITE_ENGINE_FALLBACK_PATH" default:"https://app.harness.io/storage/harness-download/harness-ti/harness-lite-engine/v0.5.104/"`
